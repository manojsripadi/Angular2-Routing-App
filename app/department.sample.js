...
var sampleDepartment = (function () {
    function sampleDepartment(_empservice, _route) {
        this._empservice = _empservice;
        this._route = _route;
        this.Employees = [];
    }
    sampleDepartment.prototype.ngOnInit = function () {
        var _this = this;
        this._empservice.getEmployee().
            subscribe(function (response) { return _this.Employees = response; });
    };
    sampleDepartment.prototype.onClick = function (employee) {
        this._route.navigate(['/Departments', employee.id]);
    };
    return sampleDepartment;
}());
sampleDepartment = __decorate([
    core_1.Component({
...
exports.sampleDepartment = sampleDepartment;
//# sourceMappingURL=department.sample.js.map